package com.example.skarimb.hackathonfirst;
                        ...
                        createAccountButton.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                if (createPassword.getText().toString().contentEquals(confirmPassword.getText().toString()))
                                {
                                    ...
                                    ((Button)findViewById(R.id.nextMealButton)).setOnClickListener(new View.OnClickListener() {
                                            public void onClick(View v) {
                                                if (i<2) {
                                                    ...
                                                    final Button salad = (Button) findViewById(R.id.saladprofilebutton);
                                                    salad.setOnClickListener(new View.OnClickListener() {
                                                        public void onClick(View v){
                                                            setContentView(R.layout.salad_profile);
                                                            final Button Ramsay = (Button) findViewById(R.id.creator);
                                                            Ramsay.setOnClickListener(new View.OnClickListener() {
                                                               public void onClick(View v){
